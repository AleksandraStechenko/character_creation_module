...
def attack(char_name: str, char_class: str) -> str:
    """
    Функция принимает название персонажа и его класс.
...
def defence(char_name: str, char_class: str) -> str:
    """
    Функция принимает название персонажа и его класс.
    Возвращает строку с результатом блокировки атаки.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """
    Функция принимает название персонажа и его класс.
    Возвращает строку с результатом применения специального умения.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """
    Функция принимает название персонажа и его класс.
    Возвращает строку с результатом тренировки.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """
    Функция запрашивает у пользователя класс персонажа.
